// Кроссворд: массив с данными (0 - пустое поле, символ - заполнено)
const crosswordData = [
		                                ["",  "",	"",	"",	"",	"",   "",   "",   "",   "",   "",   "",   "",   "",   "",   "",   "",  "",   "",   "",   "",   "",  "К",  "",   "",   "",   "",   "",   ""],
		                                ["",  "",	"",	"",	"",	"",   "",   "",   "",   "П", "О",  "Д",   "Х",  "О",   "Д",   "",   "",  "",   "П",     "Р",   "И",     "П",  "О",   "Р",     "Т",   "О",     "В",   "А",     "Я"],
		                                ["",  "",	"",	"",	"",	"",   "",   "",   "",   "Р",  "",   "",   "",   "",   "",   "",   "",  "",   "",   "",   "",   "",  "Н",   "",   "",   "",   "",   "",   ""],
		                                ["",  "",	"",	"",	"",	"",   "",   "",   "",   "И",  "",   "",   "",   "",  "",   "",   "",  "",   "",   "",   "",   "",  "Т",   "",   "",   "",   "",   "",   ""],
		                                ["",  "",	"",	"",	"",	"",   "",   "",   "",   "Ч",  "",   "",   "",   "",  "",   "",   "",  "",   "",   "",   "",   "",  "А",   "",   "",   "",   "",   "",   ""],
		                                ["",  "",	"",	"",	"",	"",   "",   "",   "",   "А",  "",   "",    "",   "", "",   "",   "",  "",   "",   "",   "",   "",  "К",   "",   "",   "",   "",   "",   ""],
		                                ["",  "",	"",	"",	"",	"",   "",   "",   "",   "Л",  "",   "",   "",   "",  "",   "",   "",  "",   "А",   "К",     "В",   "А",   "Т",    "О",      "Р",   "И",    "Я",   "",   ""],
		                                ['М','У',  'Л',	'Ь','Т','И',  "М",  "О",  "Д",  "А",  "Л",  "Ь",  "Н", "Ы", "Е",   "",   "",  "",   "",   "",    "",   "",  "Н",   "",   "",   "",   "",   "",   ""],
		                                ["",  "",	"",	"",	"",	"",   "",   "",   "",   "",   "",   "",   "",   "", "",   "",   "П",  "",   "",   "",    "",   "",  "Ы",   "",   "",   "",   "",   "",   ""],
		                                ["",  "",	"",	"",	"",	"",   "Т",  "Е",  "Х",  "Н",  "О",  "Л",  "О",  "Г","И",    "Ч", "Е", "С",   "К",     "И",    "Е",    "",  "Й",   "",   "",   "",   "",   "",   ""],
		                                ["",  "",	"",	"",	"",	"",   "",   "",   "",   "",   "Б",  "",   "",   "",  "",   "",   "Р",  "",   "",   "",   "",   "",  "",   "",   "",   "",   "",   "",   ""],
		                                ["",  "",	"",	"",	"",	"",   "",   "",   "",   "",   "С",  "",   "У",  "Н", "И",   "В", "Е",    "Р",   "С",    "А",   "Л",    "Ь",   "Н",   "Ы",      "Й",   "",   "",   "",   ""],
		                                ["",  "",	"",	"",	"",	"",   "",   "У", "З",   "Е",  "Л",  "",   "",   "О",  "", "",     "В",   "",   "У",    "",  "",   "",  "",   "",   "",   "",   "",   "",   ""],
		                                ["",  "",	"",	"",	"",	"",   "",   "",   "",   "",   "У",  "",   "",   "Р",  "",   "",   "А",   "",   "Д",    "Л",   "И",     "Н",  "А",     "",   "",   "",   "",   "",   ""],
		                                ["",  "",	"",	"",	"",	"",   "",   "",   "",   "",   "Ж",  "",   "",   "М",  "",   "",   "Л",   "",   "Н",    "",   "",   "",  "",   "",   "",   "",   "",   "",   ""],
		                                ["",  "",	"",	"",	"",	"",   "",   "",   "",   "",   "И",  "",   "",   "А",  "",   "",   "К",   "",   "О",    "",   "",   "",  "",   "",   "",   "",   "",   "",   ""],
...
const checkCrossword = async () => {
    ...
    if (isCorrect) {
        ...
        const score = 100; // Максимальный результат
        try {
...
const handleArrowNavigation = (event) => {
    ...
    // Перемещаемся на следующую заполненную ячейку
